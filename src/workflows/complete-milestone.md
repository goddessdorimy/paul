...
### Source Reference
- **GSD File:** `get-shit-done/workflows/complete-milestone.md`

### Adapted from GSD
- Readiness verification (all phases complete check)
- Statistics gathering from SUMMARY files
- Accomplishment extraction
- MILESTONES.md entry creation
- PROJECT.md evolution (requirements audit)
- Milestone archiving
- ROADMAP.md reorganization
- Git tag creation

### PAUL Innovations Beyond GSD
- **Stats as table:** Tabular format vs bullet list
- **Collapsible completed milestones:** Uses `<details>` in ROADMAP.md
- **Simpler git workflow:** No push prompts — user controls
- **Loop position update:** Clears PLAN→APPLY→UNIFY for next milestone
- **Single next action:** Suggests discuss-milestone, not multiple options
- **Celebration emoji:** 🎉 in completion banner (milestone is a moment!)
