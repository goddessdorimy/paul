...
### Source Reference
- **GSD File:** `get-shit-done/workflows/discuss-milestone.md`

### Adapted from GSD
- Prior accomplishments context (MILESTONES.md + PROJECT.md)
- Features-first exploration pattern
- Scope synthesis from features
- MILESTONE-CONTEXT.md handoff creation
- Confirmation before writing context
- Handoff routing to create-milestone

### PAUL Innovations Beyond GSD
- **Simpler question flow:** No AskUserQuestion tool references
- **One question at a time:** Conversational vs form-filling
- **Anti-patterns section:** Explicit guidance on what NOT to do
- **Session continuity note:** Explains that context persists across /clear
- **Integrated with PROJECT.md:** Uses validated/active requirements for context
- **Phase mapping table:** Tabular format for clearer structure
