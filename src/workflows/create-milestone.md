...
### Source Reference
- **GSD File:** `get-shit-done/workflows/create-milestone.md`

### Adapted from GSD
- MILESTONE-CONTEXT.md loading pattern (discuss → create handoff)
- Conversational fallback when no context exists
- ROADMAP.md milestone section format
- Phase directory creation
- STATE.md position updates
- Context cleanup after success

### PAUL Innovations Beyond GSD
- **Simpler flow:** No config mode checks or mode conditionals
- **Integrated templates:** References PAUL's ROADMAP.md template format
- **Streamlined questions:** Fewer questions, more inference
- **Loop position update:** Includes PAUL's PLAN→APPLY→UNIFY visual
- **Single next action:** Prevents decision fatigue with ONE suggested step
